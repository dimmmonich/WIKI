document.addEventListener('DOMContentLoaded', function () {
    ...
    function searchWikipedia(term) {
        const url = `https://en.wikipedia.org/w/api.php?action=query&list=search&prop=info&inprop=url&utf8=&format=json&origin=*&srlimit=500&srsearch=${encodeURIComponent(term)}`;
